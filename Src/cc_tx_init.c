...
static const registerSetting_t TX_preferredSettings[] =
  {
    ...
    { SYNC0, 0x0E },
    { SYNC_CFG1, 0x0B },
    { SYNC_CFG0, 0x0B }, /* No SYNC word. It is generated on the MPU and handled manually */
    { DCFILT_CFG, 0x1C },
	...
	{ PA_CFG0, 0x7D },
	{ PKT_LEN, 0x2C },  //2C is 44 which is pkt length, for now before ax25
	{ IF_MIX_CFG, 0x00 },
	{ FREQOFF_CFG, 0x22 },
	{ FREQ2, 0x6C },
	{ FREQ1, 0xF1 },
...
tx_registerConfig ()
{
  ...
  for (i = 0; i < (sizeof(TX_preferredSettings) / sizeof(registerSetting_t));
    ...
    cc_tx_rd_reg (TX_preferredSettings[i].addr, &rdByte);
  }
}
/**
