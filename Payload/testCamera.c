...
#include<uEye_api_64.lib>
#include<uEye_tools_64.lib>
...
//Initialize the camera parameters below.
...
//Figure out a structure for our camera code. 
...
//GENERAL NOTES 
//We can read and write I2C with both is_ReadI2C() and is_WriteI2C(). There is also an optional function that activates the I2C stop bit (is_DeviceFeature()).
